            ...
            <v-col cols="12" md="6">
                <base-material-card color="warning" inline class="px-5 py-3">
                    <template v-slot:heading>
                        ...
                        >New employees on 15th September, 2016</div>
                    </template>
                    <v-card-text>
                                ...
                                >
                                    <template v-slot:activator="{ attrs, on }">
                                        ...
                                        >
                                            ...
                                            <v-icon
                                                right
                                            >{{ menu ? 'mdi-menu-up' : 'mdi-menu-down' }}</v-icon>
                                        </v-btn>
                                    </template>
...
<script>
// Components
import PagesPlanCard from "@/layouts/pages/components/PlanCard";
