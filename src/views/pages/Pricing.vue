...
export default {
    ...
    components: {
        PagesHeading: () => import("@/layouts/pages/components/Heading"),
        PagesPlanCard: () => import("@/layouts/pages/components/PlanCard")
    },
    ...
    data: () => ({
        plans: [
            ...
            },
            {
                ...
                title: "159$",
                text:
                    "This is good if your company size is 99+ or greater Persons."
            }
        ]
    })
};
